...
function clearAppModules() {
  const modules = [
    ...
    path.join(PROJECT_ROOT, "src/request-security.js"),
    path.join(PROJECT_ROOT, "src/auth.js"),
    path.join(PROJECT_ROOT, "src/observability.js"),
    path.join(PROJECT_ROOT, "src/audit.js"),
    ...
    path.join(PROJECT_ROOT, "src/reporting/csv.js"),
    path.join(PROJECT_ROOT, "src/reporting/exports.js"),
    path.join(PROJECT_ROOT, "src/reporting/queries.js"),
    path.join(PROJECT_ROOT, "src/reporting/service.js"),
    path.join(PROJECT_ROOT, "src/sales/checkout.js"),
    path.join(PROJECT_ROOT, "src/sales/errors.js"),
    path.join(PROJECT_ROOT, "src/sales/history.js"),
    path.join(PROJECT_ROOT, "src/sales/items.js"),
    path.join(PROJECT_ROOT, "src/sales/printing.js"),
    path.join(PROJECT_ROOT, "src/sales/voiding.js"),
    ...
    path.join(PROJECT_ROOT, "src/routes/database-maintenance.js"),
    path.join(PROJECT_ROOT, "src/routes/shell.js"),
    path.join(PROJECT_ROOT, "src/routes/carts.js"),
    path.join(PROJECT_ROOT, "src/routes/system.js"),
